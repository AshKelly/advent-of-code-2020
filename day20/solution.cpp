...
std::vector<std::vector<Tile>> tile_grid(Tile current, std::list<Tile> processed_tiles){
...
std::vector<std::string> generate_image_from_grid(std::vector<std::vector<Tile>> rows){
